...
final locationDataProvider = StreamProvider<LocationData?>((ref) async* {
...
class HomeScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    // Check if locationData is available before using it
    locationData.maybeWhen(
      data: (data) {
    ...
    // Create an instance of TaskDatasource
    final TaskDatasource taskDatasource = TaskDatasource();

    // Access the CRUD counters from the TaskDatasource instance
    int createCount = taskDatasource.createCount;
    int readCount = taskDatasource.readCount;
    int updateCount = taskDatasource.updateCount;
    int deleteCount = taskDatasource.deleteCount;
            ...
            header: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const DisplayWhiteText(text: 'My Todo List', size: 20),
                  Text('Create Count: $createCount'),
                  Text('Read Count: $readCount'),
                  Text('Update Count: $updateCount'),
                  Text('Delete Count: $deleteCount'),
                ],
              ),
            ),
          ),
